...
for(i in 1:length(B)){
  ...
  avg_earnings[i] <- mean(walk_out_money - 200)
}
...
It only runs 100 times. This simulation doesn't count the back box cases in. In the reality, things may be more comlicated and unpredictable.